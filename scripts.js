...
$(document).ready(function() {
  $(".news").mouseover(function() {
    $(this)
      .children(".backgroundNews2")
      .show();
    $(this)
      .children(".backgroundNews")
      .hide();
  });
...
let playersInformations = () => {
  leaderSpot[0].innerHTML = `Zawodnik: ${
    leaders.ekstraklasa.leader.imie
  } <br/>Klub: ${leaders.ekstraklasa.leader.klub}<br/>Bramki: ${
    leaders.ekstraklasa.leader.bramki
  }`;

  viceSpot[0].innerHTML = `Zawodnik: ${
    leaders.ekstraklasa.vice.imie
  } <br/>Klub: ${leaders.ekstraklasa.vice.klub}<br/>Bramki: ${
    leaders.ekstraklasa.vice.bramki
  }`;

  thirdSpot[0].innerHTML = `Zawodnik: ${
    leaders.ekstraklasa.third.imie
  } <br/>Klub: ${leaders.ekstraklasa.third.klub}<br/>Bramki: ${
    leaders.ekstraklasa.third.bramki
  }`;

  leaderSpot[1].innerHTML = `Zawodnik: ${
    leaders.liga1.leader.imie
  } <br/>Klub: ${leaders.liga1.leader.klub}<br/>Bramki: ${
    leaders.liga1.leader.bramki
  }`;

  viceSpot[1].innerHTML = `Zawodnik: ${leaders.liga1.vice.imie} <br/>Klub: ${
    leaders.liga1.vice.klub
  }<br/>Bramki: ${leaders.liga1.vice.bramki}`;

  thirdSpot[1].innerHTML = `Zawodnik: ${leaders.liga1.third.imie} <br/>Klub: ${
    leaders.liga1.third.klub
  }<br/>Bramki: ${leaders.liga1.third.bramki}`;

  leaderSpot[2].innerHTML = `Zawodnik: ${
    leaders.liga2.leader.imie
  } <br/>Klub: ${leaders.liga2.leader.klub}<br/>Bramki: ${
    leaders.liga2.leader.bramki
  }`;

  viceSpot[2].innerHTML = `Zawodnik: ${leaders.liga2.vice.imie} <br/>Klub: ${
    leaders.liga2.vice.klub
  }<br/>Bramki: ${leaders.liga2.vice.bramki}`;

  thirdSpot[2].innerHTML = `Zawodnik: ${leaders.liga2.third.imie} <br/>Klub: ${
    leaders.liga2.third.klub
  }<br/>Bramki: ${leaders.liga2.third.bramki}`;

  leaderSpot[3].innerHTML = `Zawodnik: ${
    leaders.liga3.leader.imie
  } <br/>Klub: ${leaders.liga3.leader.klub}<br/>Bramki: ${
    leaders.liga3.leader.bramki
  }`;

  viceSpot[3].innerHTML = `Zawodnik: ${leaders.liga3.vice.imie} <br/>Klub: ${
    leaders.liga3.vice.klub
  }<br/>Bramki: ${leaders.liga3.vice.bramki}`;

  thirdSpot[3].innerHTML = `Zawodnik: ${leaders.liga3.third.imie} <br/>Klub: ${
    leaders.liga3.third.klub
  }<br/>Bramki: ${leaders.liga3.third.bramki}`;
};
playersInformations();
